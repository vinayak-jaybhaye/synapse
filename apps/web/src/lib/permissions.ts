...
export const ALL_PERMISSIONS: PermissionMeta[] = [
  // General Guild (scope: guild)
  {
    ...
    name: "Administrator",
    desc: "Grants all permissions and bypasses channel overrides.",
    scope: "guild",
  },
  {
  ...
  {
    bit: Permission.MANAGE_GUILD,
    name: "Manage Server",
    desc: "Allows members to change this server's name, switch regions, and see the server widget.",
    scope: "guild",
  },
  {
  ...
  {
    bit: Permission.CREATE_INSTANT_INVITE,
    name: "Create Invite",
  ...
  },
  {
    ...
    desc: "Allows members to change their own nickname.",
    scope: "guild",
  },
  {
  ...
  // Text Channel (scope: channel)
  {
    ...
    name: "View Channels",
    desc: "Allows members to view channels by default.",
    scope: "channel",
    appliesTo: ["text", "voice", "category"],
  },
  {
  ...
  },
  {
    ...
    desc: "Allows members to delete messages sent by others or pin any message.",
    scope: "channel",
    appliesTo: ["text", "voice", "category"],
  },
  {
    ...
    name: "Embed Links",
    desc: "Allows members' messages to automatically embed media and link previews.",
    scope: "channel",
    appliesTo: ["text", "voice", "category"],
  },
  {
    ...
    name: "Attach Files",
    desc: "Allows members to upload files or media.",
    scope: "channel",
    appliesTo: ["text", "voice", "category"],
  },
  {
    bit: Permission.READ_HISTORY,
    name: "Read Message History",
    desc: "Allows members to read previous messages sent in channels.",
    scope: "channel",
    appliesTo: ["text", "voice", "category"],
  },
  {
    ...
    desc: "Allows members to use @everyone or @here.",
    scope: "channel",
    appliesTo: ["text", "voice", "category"],
  },
  {
